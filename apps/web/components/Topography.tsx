...
// Resolves ANY valid CSS colour string (hex, oklch(), var(--token)...) via the
// browser's own colour resolution, the same fix applied to DotGrid.tsx — so
// this can take theme tokens directly instead of only literal hex.
